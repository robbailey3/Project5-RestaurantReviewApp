...
noRestaurantsFound = () => {
  const el = document.querySelector('#no-restaurants-found');
...
createRestaurantHTML = restaurant => {
  ...
  div.classList.add('restaurant-details');
  ...
  const address = document.createElement('address'); // Use semantic elements where possible
